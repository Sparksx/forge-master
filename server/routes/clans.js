...
/** Lightweight include for list endpoints — only fetches memberCount, not full member details. */
const LIGHT_CLAN_INCLUDE = { _count: { select: { members: true } } };
...
router.post('/leave', requireAuth, async (req, res) => {
    try {
        ...
        await prisma.$transaction(async (tx) => {
            ...
            // If the owner left, transfer ownership or disband
