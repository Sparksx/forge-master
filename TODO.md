...
- [x] **CORS restrictif en production** — `app.use(cors())` autorise toutes les origines. Restreindre à `https://sparksx.github.io` et au domaine du serveur en production via une variable d'environnement
